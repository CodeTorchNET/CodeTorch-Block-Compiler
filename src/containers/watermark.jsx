...
const mapStateToProps = state => {
    ...
    if (currentTargetId) {
        if (targets.stage.id === currentTargetId) {
            asset = targets.stage.costume ? targets.stage.costume.asset : null;
        } else if (Object.prototype.hasOwnProperty.call(targets.sprites, currentTargetId)) {
            const currentSprite = targets.sprites;
            asset = currentSprite.costume ? currentSprite.costume.asset : null;
        }
    }
